...
<div className="w-screen pb-12  border-t-4 border-cor5 md:pt-12 mx-auto grid grid-cols-1  gap-8 bg-cor2 pt-12 mt-20 md:px-auto">
 ...
 <ul>
    ...
    <li>     
      <a href="http://https://www.facebook.com/japanpabuyan" target="_blank" className='text-gray-400 hover:text-cor-5 transition-colors'>Facebook page</a></li>
 </ul>
    </div>
