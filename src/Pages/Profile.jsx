...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const costumerURL = `https://japan-pabuyanbackend2-0.onrender.com/customers/${ID}`
  ...
  const handeEditProfile = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        localStorage.setItem("pabuyan_user_name", updatedCustomer.name)
